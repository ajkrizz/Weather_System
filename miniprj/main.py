...
GLOB_WLAN.connect("Galaxyy22", "12345678")

while not GLOB_WLAN.isconnected():
  pass
#https://weather-wise-f8948-default-rtdb.firebaseio.com/
#firebase example
import ufirebase as firebase
firebase.setURL("https://weather-wise-f8948-default-rtdb.firebaseio.com/")
